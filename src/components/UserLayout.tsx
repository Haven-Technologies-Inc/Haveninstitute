...
const USER_MENU_ITEMS = [
  ...
  { id: 'group-study', label: 'Study Groups', icon: Users, group: 'community' },
  { id: 'forum', label: 'Forum', icon: MessagesSquare, group: 'community' },
...
export function UserLayout({ children, currentView: propCurrentView, onNavigate }: UserLayoutProps) {
  ...
  const getActiveMenuId = (pathname: string): string => {
    const reverseMap: Record<string, string> = {
      ...
      '/app/community/groups': 'group-study',
      '/app/community/forum': 'forum',
