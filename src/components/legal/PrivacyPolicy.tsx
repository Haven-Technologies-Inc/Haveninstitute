      ...
      <div className="bg-white dark:bg-gray-900 w-full h-full sm:h-auto sm:max-h-[90vh] sm:w-full sm:max-w-2xl sm:rounded-xl shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-5 py-6 sm:px-6 sm:py-8">
          <div className="max-w-none space-y-6 text-sm sm:text-base text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3">1. Information We Collect</h3>
              
              <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2">1.1 Personal Information</h4>
              <p className="text-justify mb-3">We collect information you provide directly to us, including:</p>
              ...
              <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2">1.2 Usage Information</h4>
              <p className="text-justify mb-3">We automatically collect information about your use of our services:</p>
            ...
            <section>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3">2. How We Use Your Information</h3>
              <p className="text-justify mb-3">We use the information we collect to:</p>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <section>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3">3. Information Sharing</h3>
              <p className="text-justify mb-3">We do not sell your personal information. We may share your information in the following circumstances:</p>
            ...
            <section>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3">4. Data Security</h3>
              <p className="text-justify">
            ...
            <section>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3">5. Your Rights Under Washington State Law</h3>
              <p className="text-justify mb-3">Under the Washington My Health My Data Act and other applicable laws, you have the right to:</p>
              <ul className="list-disc pl-5 space-y-2">
            ...
            <section>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3">6. Health Information</h3>
              <p className="text-justify">
            ...
            <section>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3">7. Children's Privacy</h3>
              <p className="text-justify">
            ...
            <section>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3">8. Data Retention</h3>
              <p className="text-justify">
            ...
            <section>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3">9. Third-Party Services</h3>
              <p className="text-justify">
            ...
            <section>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3">10. Changes to This Policy</h3>
              <p className="text-justify">
            ...
            <section>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3">11. Contact Us</h3>
            ...
            <section>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3">12. Consent</h3>
              <p className="text-justify">
